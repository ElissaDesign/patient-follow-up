...
export default function Doctor() {
  ...
  return (
    <div className="w-[70%] mx-auto shadow-sm my-6 py-4 ">
      <div className=" mx-2">
        ...
        <div className="flex items-center justify-between my-6 mt-14">
          ...
          <Button
            colorScheme="blue"
            className=" mx-4 basis-[20%] flex flex-row items-center"
            onClick={openRecordkModal}
          >
            <Icon icon="gala:add" className="text-xl mx-4" />
            Record a patient
          </Button>
        </div>
